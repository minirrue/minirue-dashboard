...
const nextConfig: NextConfig = {
  ...
  async rewrites() {
    return [
      ...
      { source: "/catalogue/bundles/new", destination: "/dashboard/bundles/new" },
      { source: "/catalogue/bundles/:id/edit", destination: "/dashboard/bundles/:id/edit" },
      { source: "/catalogue/bundles", destination: "/dashboard/bundles" },
      { source: "/discounts", destination: "/dashboard/discounts" },
      ...
      // dashboard#123: Story Flow — the connected visitor graph.
      { source: "/analytics/flow", destination: "/dashboard/analytics/flow" },
